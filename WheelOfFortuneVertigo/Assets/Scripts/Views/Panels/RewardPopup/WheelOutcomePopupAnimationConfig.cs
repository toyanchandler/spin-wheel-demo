...
namespace Vertigo.Wheel.Views
{
    internal static class WheelOutcomePopupAnimationConfig
    {
        ...
        public const float RewardBurstEmissionDuration = 10.8f;
        ...
        public const float FlashFadeOutDuration = 1.02f;
        public const float ShineFadeInDuration = 0.36f;
        public const float ShineHoldDuration = 0.54f;
        public const float ShineFadeOutDuration = 0.54f;
        ...
        public static readonly Vector3 IconFlightEndScale = new Vector3(0.22f, 0.22f, 1f);
    }
}
